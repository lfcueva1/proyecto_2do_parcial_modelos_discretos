...
import os
"""
Programa que valida si la cedula ingresada es valida o no
...
if __name__ == '__main__':
    ...
    print("Bienvenido")
    print("Como funciona?")
    print("     Se debe ingresar una cedula por teclado")
    print("     El programa hara varios procesos con las posiciones de los numeros para calcular el numeros verificador de la cedula")
    print("     Si el numero verificador de la cedula es el mismo que el ultimo digito de la cedula, esta sera una cedula valida")
    print("     Caso contrario es una cedula falsa")
    #pauso el codigo
    os.system("pause")
