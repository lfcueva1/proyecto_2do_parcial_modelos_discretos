...
import re
#libreria que me ayuda a ingresar la contraseña de manera segura
import getpass
import cProfile
"""
Programa que emula un login(logeo y registro) teniendo en cuenta las funciones de generar correos,verificar si una contraseña
es segura
...
def registrarse():
    ...
    print("Recuerde que para ingresar una contraseña debe tomar en cuenta lo siguiente:")
    print("1. Debe tener al menos 1o caracteres")
    print("2. Debe tener al menos 1 letra mayuscula")
    print("3. Debe tener al menos 1 letra minuscula")
    print("4. Debe tener al menos 1 letra especial")
    print("5. Debe tener al menos un numero")
...
if __name__ == '__main__':
    ...
    print("Bienvenido")
    print("Como funciona?")
    print("     El programa tiene 3 opciones,registrarse,loguearse y salir")
    print("     La primera opcion permite al usuario guardar su informacion de contacto en un archivo txt, con sus respectivas validaciones")
    print("     La segunda opcion permite al usuario ingresar al sistema con su correo y contraseña previamente registradas, al momento")
    print("     de ingresar la contraseña se mostrara invisible para dar seguridad al usuario al momento de iniciar sesion")
    print("     y por ultimo salir")
    #pauso el codigo
    os.system("pause")
    while True:
        #limpio pantalla
